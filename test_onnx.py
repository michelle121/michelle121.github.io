#存储训练好的模型，使不同的深度学习框架可以采用相同格式存储模型数据
import os
import cv2
import numpy as np
import onnxruntime
...
class Photo2Cartoon:
    def __init__(self):
        ...
        #可能需要.pt文件转换为.onnx文件
        torch.onnx.export('./models/photo2cartoon_weights.pt', args, './models/photo2cartoon_weights.onnx', export_params=True, verbose=False, input_names=None, output_names=None, do_constant_folding=True)
